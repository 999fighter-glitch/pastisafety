                    ...
                    <div key={item.id} className="bg-white p-3 rounded-xl border border-slate-200 shadow-3xs flex flex-col sm:flex-row sm:items-center gap-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex gap-2">
                          <label className="flex items-center gap-1.5 px-2.5 py-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 text-[10px] font-bold rounded-lg border border-emerald-200 cursor-pointer transition-all shadow-xs">
                            <Camera size={12} />
                            <span>Kamera</span>
                            <input
                              type="file"
                          ...
                          <label className="flex items-center gap-1.5 px-2.5 py-1.5 bg-slate-50 hover:bg-slate-100 text-slate-700 text-[10px] font-bold rounded-lg border border-slate-200 cursor-pointer transition-all shadow-xs">
                            <ImageIcon size={12} />
                            <span>Galeri</span>
                            <input
                              type="file"
                  ...
                  {formData.lampuKecemasanList.map((item) => (
                    <div key={item.id} className="bg-white p-3 rounded-xl border border-slate-200 shadow-3xs flex flex-col sm:flex-row sm:items-center gap-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {/* Photo Upload */}
                        <div className="flex gap-2">
                          <label className="flex items-center gap-1.5 px-2.5 py-1.5 bg-amber-50 hover:bg-amber-100 text-amber-700 text-[10px] font-bold rounded-lg border border-amber-200 cursor-pointer transition-all shadow-xs">
                            <Camera size={12} />
                            <span>Kamera</span>
                            <input
                              type="file"
                  ...
                  {formData.fireExtinguishers.map((ext) => (
                    <div key={ext.id} className="bg-white p-3.5 rounded-xl border border-rose-200/90 shadow-2xs flex flex-col gap-3">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-2 border-t border-slate-100">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex gap-2">
                            <label className="flex items-center gap-1.5 px-2.5 py-1.5 bg-rose-50 hover:bg-rose-100 text-rose-700 text-[10px] font-bold rounded-lg border border-rose-200 cursor-pointer transition-all shadow-xs">
                              <Camera size={12} />
                              <span>Kamera</span>
                              <input
                                type="file"
